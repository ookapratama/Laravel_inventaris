                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input required type="number" name="jumlah" id="jumlah1" class="form-control jumlah-barang">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required name="lokasi" id="lokasi1" class="form-control lokasi">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
